...
SWIFT_ENUM_FWD_DECL(NSInteger, SentryStructuredLogLevel)
...
typedef SWIFT_ENUM_NAMED(NSInteger, SentryStructuredLogLevel, "Level", closed) {
...
SWIFT_ENUM_FWD_DECL(NSUInteger, SentrySessionStatus)
...
typedef SWIFT_ENUM(NSUInteger, SentrySessionStatus, closed) {
